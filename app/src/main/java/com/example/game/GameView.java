...
import com.example.game.entity.Background;
import com.example.game.entity.Bullet;
import com.example.game.entity.Flight;
...
public class GameView extends SurfaceView implements Runnable{
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        // вычисляем середину экрана по оси Y
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN: // нажатие
                ...
                if (event.getX() < (screenX / 2)) {
                    // то движение самолёта вверх или вниз, в зависимости от положения по оси Y
